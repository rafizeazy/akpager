                    ...
                    <div class="col-lg-6">
                        <div class="about-images-service-page">
                            <div class="for-responsive">
                                <img src="{{ asset('/assets/images/about/services-page.png') }}" alt="About">
                            </div>
                            ...
                            <div class="logo">
                                <a href="{{ route('home') }}"><img src="{{ asset('/assets/images/logos/logo-top.png') }}" alt="Logo"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="iconic-box style-seven">
                            ...
                            <div class="content">
                                <h5><a href="{{ route('serviceDetails') }}">Proactive Blocklist Tracking</a></h5>
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                        <div class="iconic-box style-seven">
                            ...
                            <div class="content">
                                <h5><a href="{{ route('serviceDetails') }}">Faster Time to Inbox</a></h5>
                                <p>Sed ut perspiciatis unde omnis iste natus doloremque laudantium totamto</p>
                            </div>
                            <div class="bg">
                                <img src="{{ asset('/assets/images/shapes/iconic-box-seven-bg.png') }}" alt="Shape">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                        <div class="iconic-box style-seven">
                            ...
                            <div class="content">
                                <h5><a href="{{ route('serviceDetails') }}">Build Confidence with BIMI</a></h5>
                                <p>Sed ut perspiciatis unde omnis iste natus doloremque laudantium totamto</p>
                            </div>
                            <div class="bg">
                                <img src="{{ asset('/assets/images/shapes/iconic-box-seven-bg.png') }}" alt="Shape">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="iconic-box style-seven">
                            ...
                            <div class="content">
                                <h5><a href="{{ route('serviceDetails') }}">Manage Dedicated IPs</a></h5>
                                <p>Sed ut perspiciatis unde omnis iste natus doloremque laudantium totamto</p>
                            </div>
                            <div class="bg">
                                <img src="{{ asset('/assets/images/shapes/iconic-box-seven-bg.png') }}" alt="Shape">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                        <div class="iconic-box style-seven">
                            ...
                            <div class="content">
                                <h5><a href="{{ route('serviceDetails') }}">Dynamic suppression List</a></h5>
                                <p>Sed ut perspiciatis unde omnis iste natus doloremque laudantium totamto</p>
                            </div>
                            <div class="bg">
                                <img src="{{ asset('/assets/images/shapes/iconic-box-seven-bg.png') }}" alt="Shape">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                        <div class="iconic-box style-seven">
                            ...
                            <div class="content">
                                <h5><a href="{{ route('serviceDetails') }}">Verify DNS Records</a></h5>
                                <p>Sed ut perspiciatis unde omnis iste natus doloremque laudantium totamto</p>
                            </div>
                            <div class="bg">
                                <img src="{{ asset('/assets/images/shapes/iconic-box-seven-bg.png') }}" alt="Shape">
        ...
        <section class="client-logo-area-two pt-130 rpt-100 pb-95 rpb-65">
            ...
            <div class="container">
                <div class="row justify-content-center row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2">
                    ...
                    <div class="col">
                        <div class="client-logo-item style-three" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <a href="#"><img src="{{ asset('/assets/images/client-logos/client-logo-two5.png') }}" alt="Client Logo"></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="client-logo-item style-three" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                            <a href="#"><img src="{{ asset('/assets/images/client-logos/client-logo-two10.png') }}" alt="Client Logo"></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="client-logo-item style-three" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                            <a href="#"><img src="{{ asset('/assets/images/client-logos/client-logo-two7.png') }}" alt="Client Logo"></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="client-logo-item style-three" data-aos="fade-up" data-aos-delay="150" data-aos-duration="1500" data-aos-offset="50">
                            <a href="#"><img src="{{ asset('/assets/images/client-logos/client-logo-two6.png') }}" alt="Client Logo"></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="client-logo-item style-three" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                            <a href="#"><img src="{{ asset('/assets/images/client-logos/client-logo-two8.png') }}" alt="Client Logo"></a>
                        </div>
                    </div>
                </div>
            </div>
