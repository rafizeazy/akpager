...
@section('content')
    ...
    <!-- Page Banner Start -->
    <section class="page-banner-area overlay py-120 rpy-80 rel z-1 bgs-cover text-center" style="background-image: url({{ asset('assets/images/backgrounds/banner.jpg') }});">
        <div class="container">
